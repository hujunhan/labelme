...
class labelme2yolo():
    def __init__(
            self,
            labelme_image_path ='/Users/hu/Downloads/junhan',
            labelme_json_path = '/Users/hu/Downloads/junhan',
            save_data_path = './yolo',
            obj_name='labels.txt',
            dataset_type = 'train',
            image_type = '.jpg',
            ...
            with open(path_txt, 'w+') as ftxt:
                ...
                for shape in data['shapes']:
                    ...
                    if label in self.labels:
                        ...
                        str_annotation = str(0) + ' ' + str(x_center) + ' ' + \
                                         str(y_center) + ' ' + str(w) + ' ' + \
                                         str(h)+ '\n'
...
if __name__ == '__main__':
    labelme2yolo(r'/Users/hu/Downloads/junhan',
                                r'/Users/hu/Downloads/junhan',
                                r'./yolo',
                                )